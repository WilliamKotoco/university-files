...
//(e) o ˆangulo (argumento) de um n ´umero complexo.
...
float re;
 ...
 int main (){
 	complexo n1,n2;
 	float soma, produto, modulo, conjulgado;
	 ...
	 printf("\n Digite a parte real: ");
 		...
 		// soma
 		soma = (n1.re + n2.re) + (n1.im + n2.im);
 		
 		// produto
 		produto = (n1.re * n2.re + n1.re * n2.im) + (n1.im * n2.re + n1.im * n2.im);
 		
 		// modulo
 		modulo = sqrt(pow(n1.re, 2) + pow(n1.im, 2));
 		
 		// conjulgado
 		conjulgado = n1.re - n1.im;
