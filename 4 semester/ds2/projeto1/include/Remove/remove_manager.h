...
/**
 * Calls functions to remove the element both from struct_movie_index_id and from movie_index_name
 *  after attest the existence of it.
 */
 ...
 *
 *  Does that by moving backwards from N to i. For example, if we removed the element from the 3th position,
 *  we move the 4th position to 3th position, the 5th to 4th and so on...
 *
 */
